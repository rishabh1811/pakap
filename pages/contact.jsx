  ...
  return (
    <>
      ...
      <section className="container text-center py-8 space-y-3">
        ...
        <p className="p-gray">
          Leave your contact information below and we will contact you soon.
          Also, you can call us at <a className="font-semibold" href="tel:+919971763478">9971763478</a>
        </p>
      </section>
      <Form />
      ...
      <section className="container gradient-wrapper py-20 mt-[60px] 992:mt-[100px] 992:py-20">
        ...
        >
          <div className="flex flex-col items-center justify-center gap-3 bg-white py-3 h-[230px] 992:w-[340px]">
            ...
            <p className=" "><a href="tel:+919971763478">9971763478</a></p>
          </div>
